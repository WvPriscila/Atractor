...
def EDOs(t, r):  # ... definição do sistema de EDOs
    x, y, z = r
...
def RK4(t, r, f, dt):  # ... definiãço do método chamado método de Runge-Kutta, de 4ª ordem
    k1 = dt * f(t, r)
...
fig = plt.figure('Atrator', facecolor='k', figsize=(10, 9))
fig.tight_layout()
...
def update(i):  # ... criando a animação
    ...
    ax.set(facecolor='k')
    ax.set_axis_off()
    ax.set_title(f"Atrator - Tempo: {elapsed_seconds:.2f} segundos", color='white')
